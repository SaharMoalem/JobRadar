...
| Epic 6 — Local React web dashboard (`apps/web`) | In progress (6.1–6.3 done) |
...
Open http://127.0.0.1:5173. The shell header shows API connection status via `GET /api/career-sources` (proxied to port 8000). `/sources` and `/opportunities` are live; tracker, drafts, alerts, and notifications stay placeholders until 6.4–6.5. More detail: `apps/web/README.md`.
