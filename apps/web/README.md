...
Open http://127.0.0.1:5173. The shell header shows **Connected** when `GET /career-sources` succeeds.
...
| `npm test` | Vitest (API client envelope tests) |
